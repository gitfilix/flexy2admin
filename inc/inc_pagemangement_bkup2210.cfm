			...
			<td colspan="7" <cfif session.viewPages EQ 0>style="display:none;"</cfif> <cfoutput>id="inhalte#arguments.pageid#a"</cfoutput>>
				<div style="background-color:#e1e1e1;">
					...
					<cfoutput query="getContents">
						<tr>
							<td style="padding-left:<cfif arguments.level EQ 1>0<cfelseif arguments.level EQ 2>20<cfelseif arguments.level EQ 3>40<cfelseif arguments.level EQ 3>60<cfelseif arguments.level EQ 4>80<cfelseif arguments.level EQ 5>120</cfif>px;">#titel#</td>
							<td>
								<cfif rightEdit EQ 1>
